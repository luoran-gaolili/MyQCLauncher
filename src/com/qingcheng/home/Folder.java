...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected void onFinishInflate() {
        ...
        mFolderPageIndicatorHeight = folderPageIndicator.getMeasuredHeight();
...
//        translatedEv.recycle();
    ...
    private void centerAboutIcon() {
        ...
        */   
        ...
        lp.y = (parent.getHeight() - height + getOffsetYLand()) / 2;
		//end modify
    }
    ...
    private int getFolderHeight() {
        ...
        return mFolderContentsWidth + mFolderNameHeight - offsetY;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = mFolderContentsWidth;
        ...
        mContent.setFixedSize(mWidth,mWidth);
        mContent.measure(mWidth, mWidth);
        mScrollView.measure(mWidth, mWidth);
        folderContents.measure(mWidth,mWidth);
